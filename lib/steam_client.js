...
ProtoBuf.loadProtoFile('resources/protobufs/steamclient/steammessages_clientserver.proto', builder);
ProtoBuf.loadProtoFile('resources/protobufs/steamclient/steammessages_clientserver_2.proto', builder);
var schema = Steam.Internal = builder.build();

Steam.GC = {
  Internal: ProtoBuf.loadProtoFile('resources/protobufs/dota/steammessages.proto').build()
};
...
//  var encRequest = schema.MsgChannelEncryptRequest.decode(data);
  ...
  var encResp = new schema.MsgChannelEncryptResponse({}).toBuffer();
...
handlers[EMsg.ChannelEncryptResult] = function(data) {
  ...
  this._send(EMsg.ClientLogon | protoMask, new schema.CMsgClientLogon(this._logOnDetails).toBuffer());
};
