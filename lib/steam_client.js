...
ProtoBuf.loadProtoFile('Protobufs/steamclient/steammessages_clientserver.proto', builder);
ProtoBuf.loadProtoFile('Protobufs/steamclient/steammessages_clientserver_2.proto', builder);
var schema = Steam.Internal = builder.build();

Steam.GC = {
  Internal: ProtoBuf.loadProtoFile('Protobufs/dota/steammessages.proto').build()
};
