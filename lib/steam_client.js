...
ProtoBuf.loadProtoFile(__dirname + '/resources/protobufs/steamclient/steammessages_clientserver.proto', builder);
ProtoBuf.loadProtoFile(__dirname + '/resources/protobufs/steamclient/steammessages_clientserver_2.proto', builder);
var schema = Steam.Internal = builder.build();

Steam.GC = {
  Internal: ProtoBuf.loadProtoFile(__dirname + '/resources/protobufs/dota/steammessages.proto').build()
};
