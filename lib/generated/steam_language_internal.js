...
var MsgHdrProtoBuf = {
  ...
  serialize: function(object) {
    var bufProto = new Steam.Internal.CMsgProtoBufHeader(object.proto || {}).toBuffer();
  ...
  parse: function(buffer) {
    ...
    object.proto = Steam.Internal.CMsgProtoBufHeader.decode(buffer.slice(8, 8 + object.headerLength));
...
var MsgGCHdrProtoBuf = {
  ...
  serialize: function(object) {
    var bufProto = new Steam.GC.Internal.CMsgProtoBufHeader(object.proto || {}).toBuffer();
    object.headerLength = bufProto.length;
    var buffer = new Buffer(8 + bufProto.length);
  ...
  parse: function(buffer) {
    ...
    object.headerLength = buffer.readInt32LE(4);
    object.proto = Steam.GC.Internal.CMsgProtoBufHeader.decode(buffer.slice(8, 8 + object.headerLength));
